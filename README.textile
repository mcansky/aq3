...
It only manage ssh keys and repositories though. But just with that you can say good bye to gitosis. (well first we need to wait for some comments and tests).
...
Clone the aq_lib too and check config/application file too, tweak it accordingly to the previous one.
aq_lib contains a kindda shell (aquarii-sh.rb), you need to have it executable.

h2. Contact

On the GitHub page, and on freenode.
